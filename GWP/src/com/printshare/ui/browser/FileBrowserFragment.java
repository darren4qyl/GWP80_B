...
import com.printshare.util.AndroidDevices;
            ...
            public void run() {
                ...
                for (String mediaDirLocation : storages) {
                    if (!(new File(mediaDirLocation).exists()))
                        continue;
                    directory = new FileWrapper(AndroidUtil.PathToUri(mediaDirLocation));
                    directory.setType(FileWrapper.TYPE_DIR);
